...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/marcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutMarcoinAction = new QAction(MainWindow);
        m_aboutMarcoinAction->setObjectName(QStringLiteral("m_aboutMarcoinAction"));
        m_aboutMarcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutMarcoinAction);
        ...
        QObject::connect(m_aboutMarcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutMarcoinAction->setText(QApplication::translate("MainWindow", "About Marcoin", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND H2O", 0));
