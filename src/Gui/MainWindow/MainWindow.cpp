...
const char COMMUNITY_FORUM_URL[] = "https://www.marcoinproject.com";
const char REPORT_ISSUE_URL[] = "https://www.marcoinproject.com";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
//  setWindowTitle(tr("Marcoin Wallet %1").arg(Settings::instance().getVersion()));
